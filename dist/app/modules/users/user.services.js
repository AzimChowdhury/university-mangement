...
const as_model_1 = require("../academicSemester/as.model");
...
const createStudent = (student, user) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // set role
    user.role = 'student';
    const as = yield as_model_1.AS.findById(student.academicSemester);
    let newUserAllData = null;
    // generate student id
    const session = yield mongoose_1.default.startSession();
    try {
        session.startTransaction();
        const id = yield (0, user_utils_1.generateStudentID)(as);
        user.id = id;
        student.id = id;
...
const getStudents = () => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield student_model_1.Student.find({}).populate([
        { path: 'academicFaculty' },
        { path: 'academicDepartment' },
        { path: 'academicSemester' },
    ]);
