...
import { IAD } from '../academicDepartment/ad.interface';
...
export type IStudent = {
  ...
  academicFaculty: Types.ObjectId | IAF; // reference _id
  academicDepartment: Types.ObjectId | IAD; // // reference _id
  academicSemester: Types.ObjectId | IAS; // reference _id
  profileImage?: string;
};
